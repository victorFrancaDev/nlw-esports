...
INSERT INTO "new_Ad" ("created_at", "discord", "gameId", "hourEnd", "hourStart", "id", "useVoiceChannel", "weekDays", "yearsPlaying") SELECT "created_at", "discord", "gameId", "hourEnd", "hourStart", "id", "useVoiceChannel", "weekDays", "yearsPlaying" FROM "Ad";
DROP TABLE "Ad";
